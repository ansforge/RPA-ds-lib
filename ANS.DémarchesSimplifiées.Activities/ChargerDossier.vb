...
Public Class ChargerDossier
    ...
    <Category("Input")>
    <DisplayName("Surnoms des champs")>
    Public Property Surnoms As InArgument(Of Dictionary(Of String, String))
    ...
    Protected Overrides Sub Execute(context As CodeActivityContext)
        ...
        'End If
        Dossier.Set(context, Core.ChargerDossier(Jeton.Get(context), NuméroDossier.Get(context), Surnoms.Get(context)))
    End Sub
